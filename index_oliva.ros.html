...
<html lang="es" dir="ltr">
  <head>
    ...
    <!--Mi estilo-->
    <link rel="stylesheet" href="assets/css/style_olivia_ros.css">
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#"> <img src="assets/img_olivia_ros/logo.png" alt="Logo de Olivia Ros"> </a>
    ...
    <section class="container-fluid my-5 p-5 bg-info" id="work">
      ...
      <div class="card-deck">
        <div class="card">
          <img class="card-img-top" src="assets/img_olivia_ros/card-1.jpg" alt="Card image cap">
          <div class="card-body">
        ...
        <div class="card">
          <img class="card-img-top" src="assets/img_olivia_ros/card-2.jpg" alt="Card image cap">
          <div class="card-body">
        ...
        <div class="card">
          <img class="card-img-top" src="assets/img_olivia_ros/card-3.jpg" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img class="img-fluid mb-3" src="assets/img_olivia_ros/card-1.jpg" alt="Card image cap">
    ...
    <div class="modal fade" id="papas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img class="img-fluid mb-3" src="assets/img_olivia_ros/card-2.jpg" alt="Card image cap">
    ...
    <div class="modal fade" id="salmones" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img class="img-fluid mb-3" src="assets/img_olivia_ros/card-3.jpg" alt="Card image cap">
